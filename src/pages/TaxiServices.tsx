import { Bus, Car } from 'lucide-react'; // Import icons for the filter menu
...
export default function TaxiServices() {
  ...
  // ✅ 1. Add state to manage the current filter ('car' or 'van')
  const [filter, setFilter] = useState<'car' | 'van'>('car');

  // ✅ 2. Create a new array of vehicles based on the filter
      ...
      >
        ...
        <div className="relative container mx-auto px-6 text-center">
          ...
          <p className="text-xl text-gray-200 max-w-2xl mx-auto">
            Select your perfect ride from our premium collection of vehicles, tailored for your comfort and style.
          </p>
        </div>
      </section>

      {/* ✅ 3. Add the Filter Menu Section */}
      ...
      <section className="pt-8 pb-20">
        <div className="container mx-auto px-6">
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* ✅ 4. Map over the `filteredVehicles` array */}
