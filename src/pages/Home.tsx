...
export default function Home() {
  ...
  return (
    <div>
      {/* This Carousel is NOT animated, as requested */}
      <Carousel />

      {/* --- Section 1: Booking --- */}
      <motion.section // 3. Changed to motion.section
        className="bg-slate-800"
        // 4. Added animation props
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-2xl mx-auto">
              Experience the best airport taxi service with our focus on comfort,
              safety, and on-time arrivals.
            </p>
          </div>
          ...
          <div className="text-center">
            ...
            <p className="text-lg text-gray-400 mb-8 max-w-2xl mx-auto">
              Book your ride now and discover why travelers trust TaxiGo for
              reliable, on-time airport transportation.
            </p>
            <Link
              to="/taxi-serv"
