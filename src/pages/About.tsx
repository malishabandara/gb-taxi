import { Award, Briefcase, Clock, Gauge, MapPin, Plane, ShieldCheck, Target, Users } from 'lucide-react';
...
export default function About() {
  return (
    <div className="min-h-screen bg-gray-50 pb-16">
      ...
      <div className="relative h-96 mb-16">
        ...
        <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
          <div className="text-center text-white">
            <h1 className="text-6xl font-bold mb-4">About Sri Lankan Taxi Drivers</h1>
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="max-w-4xl mx-auto mb-16">
          ...
          <p className="text-lg text-gray-700 mb-4">
            Sri Lankan Taxi Drivers has been serving our community with dedication and excellence. What started as a small fleet of vehicles has grown into a comprehensive transportation service that thousands of customers rely on daily.
          </p>
          <p className="text-lg text-gray-700 mb-4">
      ...
      <section className="py-20 bg-gray-900 mb-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <div className="group bg-gray-800 p-8 rounded-2xl border border-gray-700 text-center transition-all duration-300 hover:border-yellow-500 hover:-translate-y-2">
              <div className="flex justify-center mb-6">
                <div className="bg-gray-700 group-hover:bg-yellow-500 rounded-full p-4 transition-colors duration-300">
                  <Plane className="w-8 h-8 text-yellow-400 group-hover:text-gray-900 transition-colors duration-300" />
                </div>
              </div>
            ...
            <div className="group bg-gray-800 p-8 rounded-2xl border border-gray-700 text-center transition-all duration-300 hover:border-yellow-500 hover:-translate-y-2">
              <div className="flex justify-center mb-6">
                <div className="bg-gray-700 group-hover:bg-yellow-500 rounded-full p-4 transition-colors duration-300">
                  <MapPin className="w-8 h-8 text-yellow-400 group-hover:text-gray-900 transition-colors duration-300" />
                </div>
              </div>
            ...
            <div className="group bg-gray-800 p-8 rounded-2xl border border-gray-700 text-center transition-all duration-300 hover:border-yellow-500 hover:-translate-y-2">
              <div className="flex justify-center mb-6">
                <div className="bg-gray-700 group-hover:bg-yellow-500 rounded-full p-4 transition-colors duration-300">
                  <Briefcase className="w-8 h-8 text-yellow-400 group-hover:text-gray-900 transition-colors duration-300" />
                </div>
              </div>
      ...
      <section className="py-20 bg-slate-900">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Why Choose Sri Lankan Taxi Drivers?
            </h2>
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            ...
            <div className="group bg-slate-800 p-8 rounded-2xl border border-slate-700 text-center transition-all duration-300 hover:border-yellow-500 hover:-translate-y-2">
              <div className="flex justify-center mb-6">
                <div className="bg-slate-700 group-hover:bg-yellow-500 rounded-full p-4 transition-colors duration-300">
                  <Plane className="w-8 h-8 text-yellow-400 group-hover:text-slate-900 transition-colors duration-300" />
                </div>
              </div>
            ...
            <div className="group bg-slate-800 p-8 rounded-2xl border border-slate-700 text-center transition-all duration-300 hover:border-yellow-500 hover:-translate-y-2">
              <div className="flex justify-center mb-6">
                <div className="bg-slate-700 group-hover:bg-yellow-500 rounded-full p-4 transition-colors duration-300">
                  <Gauge className="w-8 h-8 text-yellow-400 group-hover:text-slate-900 transition-colors duration-300" />
                </div>
              </div>
              <h3 className="text-2xl font-bold text-white mb-3">Punctuality Guaranteed</h3>
              <p className="text-slate-400">
